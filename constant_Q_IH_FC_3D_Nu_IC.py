...
Usage:
    constant_Q_IH_FC_3D_Nu_IC.py [options] 
    constant_Q_IH_FC_3D_Nu_IC.py <config> [options] 
...
def set_subs(problem):
    ...
    problem.substitutions['visc_L_y'] = '((μ/rho0)*visc_div_stress_y)'
    ...
    problem.substitutions['visc_R_y'] = '((μ/rho_full)*visc_div_stress_y - visc_L_y)'
...
def run_cartesian_convection(args):
    ...
    variables = ['ln_rho1', 'T1', 'T1_z', 'u', 'v',  'w', 'u_z', 'v_z', 'w_z']
